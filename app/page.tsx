    ...
    <div className="min-h-screen bg-[#121412] text-white font-sans selection:bg-primary selection:text-black">
      ...
      <div className="bg-[#ccff00] text-black w-full rounded-b-[3rem] lg:rounded-b-[4rem] px-6 lg:px-20 pb-20 relative overflow-hidden">
        ...
        <header className="flex items-center justify-between py-6 max-w-[1400px] mx-auto z-10 relative">
          ...
          <nav className="hidden md:flex items-center gap-8 font-bold text-[10px] tracking-widest uppercase">
            ...
            <Link href="https://merchants.irion.network" className="hover:opacity-70 transition-opacity">Merchants</Link>
        ...
        <div className="max-w-[1400px] mx-auto mt-20 lg:mt-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center z-10 relative">
          ...
          >
            <h1 className="text-5xl lg:text-7xl font-black leading-[0.9] tracking-tight uppercase">
              One Protocol.<br />Two Markets.<br />No Compromises.
            </h1>
            <p className="text-sm lg:text-base font-medium max-w-md leading-relaxed">
              Developing a unified financial infrastructure on Algorand. Privacy-preserving credit rails for the unbanked and automated cross-border treasury management.
            </p>
            <div>
              <Link
                href="https://app.irion.network"
      ...
      <main className="max-w-[1400px] mx-auto px-6 lg:px-20 py-24 flex flex-col gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-12 lg:gap-24 items-center opacity-60 grayscale pb-10">
          <span className="font-bold text-2xl tracking-tighter">ZK-Private Credit</span>
          <span className="font-bold text-2xl tracking-tighter">Cross-Border Treasury</span>
          <span className="font-bold text-2xl tracking-tighter">Algorand Network</span>
          <span className="font-bold text-2xl tracking-tighter">Unified Compliance</span>
        </div>
        ...
        >
          <div className="max-w-xl">
            <h2 className="text-3xl lg:text-4xl font-black mb-4 tracking-tighter uppercase">Building on Algorand</h2>
            <p className="font-medium text-sm leading-relaxed opacity-80">
              Leveraging ZK-Private architecture to enable seamless credit management and institutional-grade treasury tools without compromising security.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <div className="z-10 max-w-sm mb-12">
              <h3 className="text-3xl lg:text-5xl font-black uppercase tracking-tight leading-[0.9] mb-4">ZK-Private<br />Credit</h3>
              <p className="font-medium text-sm lg:text-base opacity-80 leading-relaxed">
                Empowering the unbanked with portable credit scores. Local data verification meets ZK-proofs to unlock financial history without revealing identity.
              </p>
            </div>
          ...
          >
            <div className="z-10 max-w-sm mb-8 relative">
              <h3 className="text-3xl lg:text-4xl font-black uppercase tracking-tight leading-[0.9] mb-4">Identity &<br />Compliance</h3>
              <p className="font-medium text-sm opacity-80 leading-relaxed">
                Building toward a MiCA/FINMA ready future. One-click audit exports and portable identities ensure global trust.
              </p>
            </div>
            {/* Graphics mock */}
          ...
          >
            <div className="z-10 max-w-sm mb-8 relative">
              <h3 className="text-3xl lg:text-4xl font-black uppercase tracking-tight leading-[0.9] mb-4">Automated<br />Treasury</h3>
              <p className="font-medium text-sm opacity-80 leading-relaxed">
                Bridging currencies with autonomous rebalancing and on-chain FX hedging. Efficiency designed for modern enterprises.
              </p>
            </div>
        ...
        >
          ...
          <div className="relative w-64 h-64 flex items-center justify-center">
            ...
            {/* Center YO */}
            <div className="absolute text-5xl font-black text-[#ccff00] tracking-tighter">Irion</div>
          </div>
