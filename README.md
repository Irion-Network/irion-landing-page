...
Welcome to the **Irion Landing Page** repository! This is the public-facing promotional website for **Irion**, a decentralized Cross-Chain Buy Now Pay Later (BNPL) protocol. 
...
## 🌍 About Irion
Irion enables decentralized credit by utilizing Chainlink CCIP to pass messages between Satellite Chains (where collateral is locked) and the Master Chain (where credit and debt are managed).

For the actual decentralized application and user dashboard, please see the [`Irion-network`](../Irion-network) project within this workspace.
